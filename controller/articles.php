...
class articles extends Core {
	...
	public function get_content() {
		...
		$res = $this->m->get_articles_lean($this->start_pos, $this->perpage);
		// $res = $this->m->get_articles('Статьи', $this->start_pos, $this->perpage);
		return $res;
	}
	...
	protected function pos() {
		...
		$count_rows = $this->m->count_rows_articles();
