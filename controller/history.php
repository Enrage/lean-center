...
class history extends Core {
	...
	public function get_content() {
		...
		$res = $this->m->get_history_lean($this->start_pos, $this->perpage);
		// $res = $this->m->get_articles('История проектов', $this->start_pos, $this->perpage);
		return $res;
	}
	...
	protected function pos() {
		...
		$count_rows = $this->m->count_rows_history();
